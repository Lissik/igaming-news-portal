...
export const ARTICLES: Article[] = [
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "EU Proposes Unified Online Gambling Licensing Framework | iGaming Wire",
  ...
  },
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "Evolution Gaming Record Q4 2025 Revenue & Asia Expansion | iGaming Wire",
  ...
  },
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "UK Gambling White Paper Reforms 2026 Implementation | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "First-Party Data Strategy for iGaming Affiliates 2026 | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Betsson New Sportsbook Latin America 2026 | iGaming Wire",
  ...
  },
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "Crypto Payments iGaming 2026 Stablecoin Adoption | iGaming Wire",
  ...
  {
    id: "7",
    slug: "ice-london-2026-preview-key-themes",
    language: "en",
    translationGroupId: "tg-7",
    title: "ICE London 2026 Preview: AI, Regulation and Responsible Gambling Dominate the Agenda",
    excerpt:
      "With over 700 exhibitors confirmed at ExCeL London, ICE 2026 promises to be the biggest edition yet. We preview the key themes, must-attend sessions, and major product launches expected this year.",
    content: `ICE London 2026 returns to ExCeL London next month with a record 700+ exhibitors confirmed and attendance projected to exceed 50,000 visitors across three days. The event, organized by Clarion Gaming, remains the iGaming industry's premier global gathering and the definitive launchpad for new products and partnerships.\n\nThree themes are expected to dominate: artificial intelligence in personalization and fraud detection, regulatory compliance tools for an increasingly complex global landscape, and responsible gambling technology following heightened regulator scrutiny across key markets.\n\nNotable confirmed keynote speakers include Malta Gaming Authority CEO Yanica Sant, Kindred Group's Head of Sustainability, and representatives from the Emerging Regulatory Technology Association.\n\nOn the exhibition floor, Evolution, Pragmatic Play, and NetEnt parent company Light & Wonder are all expected to unveil new game portfolios. Several B2B platform providers are also planning major announcements, including at least two significant M&A reveals.\n\nThe iGaming Wire team will be covering ICE London in full, including daily show floor reports, interview series, and a post-show analysis piece.`,
    featuredImage: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80",
    author: AUTHORS[1],
    publishedAt: "2026-02-17T08:30:00Z",
    category: "conferences-events",
    tags: [{ id: "t18", label: "ICE London", slug: "ice-london" }, { id: "t19", label: "Events", slug: "events" }, { id: "t20", label: "AI", slug: "ai" }],
    sourceName: "Clarion Gaming",
    sourceUrl: "https://www.icelondon.uk.com",
    featured: true,
    trending: true,
    sponsored: false,
    seoTitle: "ICE London 2026 Preview: Key Themes and Exhibitors | iGaming Wire",
    metaDescription: "Our ICE London 2026 preview covers the dominant themes, key speakers, and major product launches expected at ExCeL London.",
    likes: 72,
    comments: [
      { id: "c6", author: "EventGoer", content: "Looking forward to the AI in personalization sessions. This is genuinely the year it becomes mainstream.", publishedAt: "2026-02-17T12:00:00Z" },
      { id: "c7", author: "B2BRep", content: "Will iGaming Wire have a stand this year?", publishedAt: "2026-02-18T09:00:00Z" },
    ],
  },
  {
    id: "8",
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Pragmatic Play New Slots Q1 2026 Release Schedule | iGaming Wire",
  ...
  },
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "Google Gambling Ads Policy 2026 Brazil Colombia Argentina | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: true,
    seoTitle: "Nuvei iGaming Hub Payment Orchestration Launch 2026 | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Self-Exclusion Tools Effectiveness Study 2026 | iGaming Wire",
  ...
  },
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "SoftSwiss AI Personalization Casino Platform 2026 | iGaming Wire",
  ...
  {
    id: "13",
    slug: "affiliate-summit-europe-2026-agenda",
    language: "en",
    translationGroupId: "tg-13",
    title: "Affiliate Summit Europe 2026 Reveals Full Agenda: Performance Marketing, AI Tools and Compliance Top the Bill",
    excerpt:
      "ASE 2026 will take place in Barcelona this May with a record 5,000 attendees expected. The agenda covers performance marketing technology, AI-assisted content creation, and evolving affiliate compliance requirements.",
    content: `Affiliate Summit Europe 2026 has published its full conference agenda ahead of the event scheduled for May 12-14 in Barcelona. The three-day event is projected to attract over 5,000 attendees from across the performance marketing and affiliate industry, with a significant concentration of iGaming affiliates and operators.\n\nThe 2026 agenda reflects the industry's current preoccupations: artificial intelligence tools for content creation and SEO, evolving regulatory requirements for affiliate marketing communications, and the shift toward first-party data strategies following the end of third-party cookies.\n\nThe opening keynote will be delivered by a senior Google representative discussing Google's approach to AI-generated content and its SEO implications — a topic of acute concern for iGaming affiliates heavily dependent on organic search traffic.\n\nA dedicated iGaming track will run across all three days, featuring sessions on CPA deal structures in emerging markets, responsible marketing standards, and operator-affiliate data sharing agreements.\n\nRegistration is currently open with early bird pricing available until April 1.`,
    featuredImage: "https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=800&q=80",
    author: AUTHORS[1],
    publishedAt: "2026-03-18T09:00:00Z",
    category: "conferences-events",
    tags: [{ id: "t36", label: "Affiliate Summit", slug: "affiliate-summit" }, { id: "t37", label: "Barcelona", slug: "barcelona" }, { id: "t38", label: "Performance Marketing", slug: "performance-marketing" }],
    sourceName: "Affiliate Summit",
    sourceUrl: "https://www.affiliatesummit.com",
    featured: false,
    trending: false,
    sponsored: false,
    seoTitle: "Affiliate Summit Europe 2026 Barcelona Agenda | iGaming Wire",
    metaDescription: "Affiliate Summit Europe 2026 in Barcelona releases its full agenda covering AI tools, compliance, and first-party data for performance marketers.",
    likes: 18,
    comments: [],
  },
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "US Sports Betting Market $14.2B 2025 DraftKings FanDuel | iGaming Wire",
  ...
  },
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "SEO AI Content Guide for iGaming Affiliates 2026 | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Evoke 888 Holdings B2B Platform Strategy 2026 | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Ontario iGaming Market Three-Year Review 2026 | iGaming Wire",
  ...
  },
  {
    ...
    trending: true,
    sponsored: false,
    seoTitle: "iGaming B2B M&A Activity Q1 2026 Platform Consolidation | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Brazil Sports Betting Licensed Operators Market Launch 2026 | iGaming Wire",
  ...
  },
  {
    ...
    title: "iGaming Wire Launches Media Partnership Programme for Industry Conferences and Events",
    excerpt:
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Playtech Hard Rock Bet USA Platform Agreement 2026 | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "European Affiliate Compliance 2026 Operator Obligations | iGaming Wire",
  ...
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Open Banking Gambling Deposits UK 12% Market Share 2026 | iGaming Wire",
  ...
  {
    id: "24",
    slug: "gaming-malta-forum-2026-announcement",
    language: "en",
    translationGroupId: "tg-24",
    title: "Gaming Malta Forum 2026 Confirmed for October, Expanding to Three-Day Format with Dedicated Startup Track",
    excerpt:
      "The Malta Gaming Authority and Gaming Malta have confirmed the Gaming Malta Forum will expand to a three-day event in October 2026, adding a dedicated startup and investment track.",
    content: `The Gaming Malta Forum has confirmed it will expand from its traditional two-day format to three days for its 2026 edition, scheduled for October 14-16 at the Malta Marriott Hotel & Spa.\n\nThe expansion includes a new dedicated startup and investment track, designed to connect early-stage iGaming technology companies with investors, accelerators, and potential operator customers. The track will feature pitch competitions, investor roundtables, and mentorship sessions from senior industry executives.\n\n"Malta's position as the EU's leading iGaming hub makes it the natural home for startup talent entering the regulated market," said Dr. Carl Brincat, Malta Gaming Authority CEO. "We want to nurture the next generation of iGaming businesses from their earliest stages."\n\nThe main conference will focus on regulation, B2B technology, and market expansion in emerging territories. The MGA will use the event to present its regulatory strategy for 2027-2030, which is expected to address AI governance, crypto asset gambling, and cross-border player protection coordination.\n\nEarly bird registration opens May 1, 2026.`,
    featuredImage: "https://images.unsplash.com/photo-1578574577315-3fbeb0cecdc2?w=800&q=80",
    author: AUTHORS[1],
    publishedAt: "2026-03-22T09:00:00Z",
    category: "conferences-events",
    tags: [{ id: "t69", label: "Malta", slug: "malta" }, { id: "t70", label: "Gaming Malta Forum", slug: "gaming-malta-forum" }, { id: "t71", label: "MGA", slug: "mga" }],
    sourceName: "Gaming Malta",
    sourceUrl: "https://www.gamingmalta.gov.mt",
    featured: false,
    trending: false,
    sponsored: false,
    seoTitle: "Gaming Malta Forum 2026 October Three-Day Format | iGaming Wire",
    metaDescription: "Gaming Malta Forum 2026 expands to three days in October, adding a startup and investment track to its established B2B and regulation agenda.",
    likes: 16,
    comments: [],
  },
  {
    ...
    trending: false,
    sponsored: false,
    seoTitle: "Flutter Entertainment 2025 Annual Results $6.2B Revenue | iGaming Wire",
